...
const {sendMedia,sendMessage_text,generateQrCode,test,addNewClient,generateQrCodeNew,isClientReady_data,generateQrCodeNew2} = require("../controllers/waController");
