...
var connection = mysql.createConnection({
  ...
  connection.connect(function(err) {
    ...
    function update_source_user_mob(source_id,source_name,source_mobile,source_deviceType ,source_isBussenis ,source_status){
      //connection.connect(function(err) {
          //if (err) throw err;
          //console.log("Connected!");
          ...
          var sql = "UPDATE source SET source_name = '"+source_name+"' , source_mobile = '"+source_mobile+"' , source_deviceType = '"+source_deviceType+"' , source_isBussenis = '"+source_isBussenis+"' , source_status = '"+source_status+"' , source_Login_Datetime = '"+currentTime_login+"' WHERE source_id = '"+source_id+"'";
          connection.query(sql, function (err, result) {
            if (err) throw err;
    ...
    function update_source_disconnected(source_id,source_status){
        //connection.connect(function(err) {
            ...
            var sql = "UPDATE source SET source_status = '"+source_status+"' , source_LogOut_Datetime = '"+currentTime_out+"' WHERE source_id = '"+source_id+"'";
            connection.query(sql, function (err, result) {
              if (err) throw err;
              console.log(result.affectedRows + " record(s) updated");
            });
...
this_client.on('ready', async() => {
    ...
    update_source_user_mob(id, clientInfo.pushname, clientInfo.wid.user, clientInfo.platform , clientInfo.isBusiness ,'A');
